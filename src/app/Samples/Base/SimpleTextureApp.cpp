...
SimpleTextureApp::~SimpleTextureApp() {
}

bool SimpleTextureApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void SimpleTextureApp::draw(const float dt) {
