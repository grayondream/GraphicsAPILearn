#include "IBLIrradianceConversionApp.hpp"
#include <glm/glm.hpp>
...
IBLIrradianceConversionApp::~IBLIrradianceConversionApp() {}

void IBLIrradianceConversionApp::initShapes() {
    Cube cube{};
...
bool IBLIrradianceConversionApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void IBLIrradianceConversionApp::initCaptureViews() {
...
void IBLIrradianceConversionApp::initFramebuffer() {
...
void IBLIrradianceConversionApp::compileShader(const rhi::VertexLayout& cubeLayout) {
    ...
    m_cubeMapProgram->setDepthTest(false);
...
void IBLIrradianceConversionApp::loadTexture() {
...
void IBLIrradianceConversionApp::renderToCubemap() {
...
void IBLIrradianceConversionApp::renderCube(const std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& model) {
...
void IBLIrradianceConversionApp::renderSphere(const std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& model) {
    renderer()->setPipeline(program);
...
void IBLIrradianceConversionApp::renderBeforeLoop() {
    renderToCubemap();
    renderer()->flush();
    m_envCubemap->genCubeMipmaps();
}

void IBLIrradianceConversionApp::renderBackground(const std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& view, const glm::mat4& projection) {
    renderer()->setPipeline(program);
...
void IBLIrradianceConversionApp::renderObjectsAndLights(const std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& view, const glm::mat4& projection) {
...
void IBLIrradianceConversionApp::draw(const float dt) {
