...
std::shared_ptr<rhi::IPipeline> MsaaApp::compileShader(const std::string& name, const rhi::VertexLayout& layout) {
...
void MsaaApp::compileShader(const rhi::VertexLayout& layout) {
	_pipeline = compileShader("Cube", layout);
	_postPipeline = compileShader("Post", layout);
}

bool MsaaApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void MsaaApp::createFrameBuffer() {
...
void MsaaApp::createPostFrameBuffer() {
...
void MsaaApp::drawFrameBufferMssa() {
...
void MsaaApp::draw(const float dt) {
