...
bool ShadowApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void ShadowApp::createQuadBuffer() {
...
void ShadowApp::createShadowDepthBuffer() {
...
void ShadowApp::compileShader(const rhi::VertexLayout& cubeLayout, const rhi::VertexLayout& quadLayout) {
...
void ShadowApp::renderCube(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& model, const int type) {
    ...
    rhi::SetUniform(_ubo, "type", 0);   // 原生 renderCube 绘后必归 0（ShadowApp.cpp:245）
}

void ShadowApp::renderPlane(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& model) {
    renderer()->setPipeline(program);
...
void ShadowApp::renderScene(std::shared_ptr<rhi::IPipeline>& program, const glm::vec3& lightPos) {
...
void ShadowApp::renderScene2FrameBuffer(const glm::mat4& lightSpaceMatrix, const glm::vec3& lightPos) {
...
void ShadowApp::renderDepthDebug() {
