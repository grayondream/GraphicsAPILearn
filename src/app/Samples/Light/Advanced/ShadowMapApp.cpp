...
bool ShadowMapApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void ShadowMapApp::createTextures() {
...
void ShadowMapApp::createShadowDepthBuffer() {
...
void ShadowMapApp::compileShader(const rhi::VertexLayout& cubeLayout, const rhi::VertexLayout& screenLayout) {
...
void ShadowMapApp::renderScene2FrameBuffer() {
