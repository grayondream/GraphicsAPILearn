...
void DeferApp::createQuadBuffer() {
	float quadVertices[] = {
...
void DeferApp::createFrameBuffers() {
...
bool DeferApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void DeferApp::compileShader(const rhi::VertexLayout& cubeLayout, const rhi::VertexLayout& quadLayout) {
...
void DeferApp::renderQuad() {
	renderer()->setVertexBuffer(m_quadVb);
	renderer()->draw(m_quadVertexCount, 0);
}

void DeferApp::renderOneCube(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4& model, const glm::mat4& projection, const glm::mat4& view){
...
void DeferApp::renderCubes(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4 &projection, const glm::mat4 &view, const glm::vec3 &viewPos) {
...
void DeferApp::renderPlane(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4 &projection, const glm::mat4 &view, const glm::vec3 &viewPos) {
	renderer()->setPipeline(program);
...
void DeferApp::renderLight(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4 &projection, const glm::mat4 &view) {
	renderer()->setPipeline(program);
...
void DeferApp::renderLightBox(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4 &projection, const glm::mat4 &view) {
	renderer()->setPipeline(program);
...
void DeferApp::renderGBuffer(std::shared_ptr<rhi::IPipeline>& program, const glm::mat4 &projection, const glm::mat4 &view) {
...
void DeferApp::draw(const float dt) {
