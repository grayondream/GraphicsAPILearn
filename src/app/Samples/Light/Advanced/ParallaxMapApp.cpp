...
bool ParallaxMapApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void ParallaxMapApp::createTextures() {
...
void ParallaxMapApp::compileShader() {
