...
static RhiGeometry::Geometry CreateCubeBuffer(rhi::IRenderer* renderer) {
	// 原始 36 顶点 cube：每顶点 8 float（pos3 + normal3 + uv2），与 HdrApp.cpp 原 CreateRectBuffer 相同
	float vertices[] = {
...
bool HdrApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void HdrApp::compileShader(const rhi::VertexLayout& cubeLayout, const rhi::VertexLayout& quadLayout) {
...
void HdrApp::render2FrameBuffer() {
