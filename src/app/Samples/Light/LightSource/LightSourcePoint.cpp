...
LightSourcePoint::~LightSourcePoint() {
}

bool LightSourcePoint::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void LightSourcePoint::draw(const float dt) {
	ImGui::Begin("OpenGL");
