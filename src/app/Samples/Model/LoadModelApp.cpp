...
LoadModelApp::~LoadModelApp() {
}

bool LoadModelApp::load(std::shared_ptr<rhi::IRenderer> rhiRenderer) {
...
void LoadModelApp::draw(const float dt) {
	drawUI();
