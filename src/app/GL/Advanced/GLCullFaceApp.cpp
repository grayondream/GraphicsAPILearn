...
void GLCullFaceApp::compileShader() {
	const auto vfile = StaticCollector::getGLShaderPath() / "Advanced" / "CullFace" / "Basic.vert";
	const auto ffile = StaticCollector::getGLShaderPath() / "Advanced" / "CullFace" / "Basic.frag";
