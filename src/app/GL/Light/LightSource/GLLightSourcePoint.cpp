#include "GLLightSourcePoint.hpp"
...
bool GLLightSourcePoint::init(const HINSTANCE inst, const WindowDesc& param) {
...
void GLLightSourcePoint::createVertexBuffer() {
...
void GLLightSourcePoint::clearColor() {
	return GLApp::clearColor();
}

void GLLightSourcePoint::beginDrawScene() {
	return GLApp::beginDrawScene();
}

void GLLightSourcePoint::drawScene(const float dt) {
	GLApp::drawScene(dt);
...
void GLLightSourcePoint::endDrawScene() {
	return GLApp::endDrawScene();
}

void GLLightSourcePoint::onKeyBoardEvent(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
	switch (msg) {
	case WM_KEYDOWN:
		break;
	case WM_KEYUP:
...
void GLLightSourcePoint::onMouseDown(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONDOWN:
...
void GLLightSourcePoint::onMouseUp(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONUP:
...
void GLLightSourcePoint::onMouseMove(WPARAM btnState, int x, int y) {
	if (!_mouseClicked) {
...
void GLLightSourcePoint::onMouseScroll(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
