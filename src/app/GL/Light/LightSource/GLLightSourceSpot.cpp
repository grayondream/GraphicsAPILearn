...
bool GLLightSourceSpot::init(const HINSTANCE inst, const WindowDesc& param) {
...
void GLLightSourceSpot::clearColor() {
	return GLApp::clearColor();
}

void GLLightSourceSpot::beginDrawScene() {
...
void GLLightSourceSpot::endDrawScene() {
	return GLApp::endDrawScene();
}

void GLLightSourceSpot::onKeyBoardEvent(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
	switch (msg) {
	case WM_KEYDOWN:
		break;
	case WM_KEYUP:
...
void GLLightSourceSpot::onMouseDown(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONDOWN:
...
void GLLightSourceSpot::onMouseUp(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONUP:
...
void GLLightSourceSpot::onMouseMove(WPARAM btnState, int x, int y) {
	if (!_mouseClicked) {
...
void GLLightSourceSpot::onMouseScroll(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
