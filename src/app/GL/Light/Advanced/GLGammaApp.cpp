...
bool GLGammaApp::init(const HINSTANCE inst, const WindowDesc& param) {
...
void GLGammaApp::clearColor() {
	return GLApp::clearColor();
}

void GLGammaApp::beginDrawScene() {
...
void GLGammaApp::endDrawScene() {
	return GLApp::endDrawScene();
}

void GLGammaApp::onKeyBoardEvent(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
	switch (msg) {
	case WM_KEYDOWN:
		break;
	case WM_KEYUP:
...
void GLGammaApp::onMouseDown(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONDOWN:
...
void GLGammaApp::onMouseUp(const UINT msg, WPARAM btnState, int x, int y) {
	switch (msg) {
	case WM_LBUTTONUP:
...
void GLGammaApp::onMouseMove(WPARAM btnState, int x, int y) {
	if (!_mouseClicked) {
...
void GLGammaApp::onMouseScroll(const UINT msg, const WPARAM wParam, const LPARAM lParam) {
