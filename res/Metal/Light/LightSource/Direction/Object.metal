...
vertex VertexOut Direction_Object_vertex(VertexIn in [[stage_in]],
...
fragment float4 Direction_Object_fragment(VertexOut in [[stage_in]],
                                           constant UniformBlock& ubo [[buffer(8)]],
    ...
    float3 lightDir = normalize(-ubo.lights[0].direction.xyz);
